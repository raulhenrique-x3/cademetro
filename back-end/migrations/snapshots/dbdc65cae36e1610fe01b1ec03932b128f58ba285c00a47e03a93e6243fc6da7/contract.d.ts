...
export type StorageHash =
  StorageHashBase<'dbdc65cae36e1610fe01b1ec03932b128f58ba285c00a47e03a93e6243fc6da7'>;
export type ExecutionHash =
  ExecutionHashBase<'3dc56a4f7f0e7fb80cbfa66642ca5f0b5d0f093220baa5d976e929ec39f3a8df'>;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly stationLine: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['lineId', 'stationId'] },
                { readonly columns: readonly ['lineId', 'order'] },
              ];
              indexes: readonly [
                {
                  readonly name: 'stationLine_lineId_idx_4b6c5a21';
                  readonly prefix: 'stationLine_lineId_idx';
                  readonly columns: readonly ['lineId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'stationLine_stationId_idx_0626a60c';
                  readonly prefix: 'stationLine_stationId_idx';
                  readonly columns: readonly ['stationId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'stationLine';
                    readonly columns: readonly ['lineId'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
